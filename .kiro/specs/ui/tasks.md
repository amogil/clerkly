...
- [ ] 1.4 Реализовать метод saveState()
...
- [ ] 1.5 Реализовать метод getDefaultState()
...
- [ ] 1.6 Реализовать метод isPositionValid()
...
- [ ] 2.3 Реализовать метод setupStateTracking()
...
- [ ] 2.4 Реализовать метод saveCurrentState()
...
- [ ] 3.1 Написать тест: should return default state when no saved state exists
...
- [ ] 3.2 Написать тест: should load saved state from database
...
- [ ] 3.3 Написать тест: should return default state for invalid position
...
- [ ] 3.4 Написать тест: should save state to database
...
- [ ] 3.5 Написать тест: should handle save errors gracefully
...
- [ ] 3.6 Написать тест: should handle corrupted state data
...
- [ ] 4.1 Написать тест: should create window with correct initial configuration
...
- [ ] 4.2 Написать тест: should save state when window is resized
  - Создать окно
...
- [ ] 4.3 Написать тест: should save maximized state
  - Создать окно
  - Mock DataManager.set()
...
- [ ] 4.4 Написать тест: should handle window creation errors
...
- [ ] 5.1 Написать property-based тест: should generate default state based on screen size
...
- [ ] 5.2 Написать property-based тест: should preserve state through save/load cycle
...
- [ ] 5.3 Написать property-based тест: should save state on any window state change
  - Использовать fast-check для генерации различных WindowState
  - Создать окно
...
- [ ] 6.1 Написать интеграционный тест: should persist and restore window state across restarts
...
- [ ] 7.1 Написать функциональный тест: should open application with correct initial window state
...
- [ ] 7.2 Написать функциональный тест: should persist window state across restarts
...
- [ ] 7.3 Написать функциональный тест: should persist maximized state across restarts
  - Запустить приложение
...
- [ ] 7.4 Написать функциональный тест: should adapt window size to small screens
...
- [ ] 8.1 Добавить JSDoc комментарии к WindowStateManager
  - Документировать все публичные методы
  - Добавить примеры использования
  - Указать ссылки на требования в комментариях
  - **Requirements:** ui.5

- [ ] 8.2 Добавить JSDoc комментарии к расширениям WindowManager
...
- [ ] 9.3 Проверить комментарии с требованиями
