...
- [ ] Задача 10.4: Реализовать `fetchProfileSynchronously()` в UserProfileManager
- [ ] Задача 12.3: Добавить loader во время синхронной загрузки профиля
- [ ] Задача 12.4: Расширить LoginError для обработки 'profile_fetch_failed'

### Централизованная Обработка API Запросов (Property 29-31, 34-36)
- [ ] Задача 37.1: Создать `handleAPIRequest()` с проверкой HTTP 401
- [ ] Задача 37.2: Интегрировать с UserProfileManager
- [ ] Задача 37.3: Интегрировать с другими API клиентами

### Автоматическое Обновление Токенов (Property 28, 33)
- [ ] Задача 38.1: Проверить/улучшить `refreshAccessToken()`
- [ ] Задача 38.2: Добавить автоматический триггер refresh

### Обработка Race Conditions (Property 30, 35)
- [ ] Задача 39.1: Добавить защиту от множественных очисток токенов
- [ ] Задача 39.2: Добавить тесты для одновременных 401 ошибок
