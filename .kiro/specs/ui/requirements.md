...
**User Story:** Как пользователь, я хочу чтобы приложение запускалось в развернутом окне, чтобы максимально использовать пространство экрана для работы.

**Зависимости:** Нет

#### Критерии Приемки

1.1. WHEN приложение запускается, THE "Main Window" SHALL открываться в развернутом состоянии (maximized)

1.2. THE "Main Window" SHALL НЕ открываться в полноэкранном режиме (fullscreen)

1.3. THE "Main Window" SHALL сохранять возможность изменения размера пользователем
