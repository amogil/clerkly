...
4.13.11. Для реализации скроллбара ДОЛЖЕН использоваться компонент ScrollArea из @radix-ui/react-scroll-area (shadcn/ui)
...
4.14.5. Позиции скролла ДОЛЖНЫ храниться в Map<agentId, scrollTop> в памяти компонента (НЕ в localStorage)
