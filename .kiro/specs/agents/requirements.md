...
### 13. Ленивая загрузка истории сообщений

**ID:** agents.13

**User Story:** Как пользователь, я хочу видеть историю переписки при прокрутке вверх, чтобы приложение оставалось быстрым даже при длинной истории.

#### Критерии Приемки

13.1. При открытии агента ДОЛЖНЫ загружаться последние 50 сообщений

13.2. КОГДА пользователь прокручивает чат к верхней границе, ТО ДОЛЖНЫ подгружаться следующие 50 сообщений

13.3. Позиция скролла НЕ ДОЛЖНА прыгать при подгрузке старых сообщений
