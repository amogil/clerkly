...
- [x] 1.1 Написать модульные тесты для ErrorNotificationManager
...
- [ ] 2. Создать NotificationUI компонент
  ...
  - [x] 2.2 Создать стили для NotificationUI
  ...
  - [x] 2.3 Написать модульные тесты для NotificationUI
...
- [ ] 3. Создать Error Handler в Main Process
  ...
  - [x] 3.2 Реализовать фильтрацию race condition ошибок
  ...
  - [x] 3.3 Написать модульные тесты для Error Handler
...
- [ ] 6. Интегрировать с существующими компонентами
  ...
  - [x] 6.2 Обновить обработку ошибок в UserProfileManager
    - Использовать `handleBackgroundError()` для ошибок загрузки профиля
    - Передавать контекст "Profile Loading"
    - _Requirements: error-notifications.1.1, error-notifications.1.4_

  - [x] 6.3 Обновить обработку ошибок в других фоновых процессах
