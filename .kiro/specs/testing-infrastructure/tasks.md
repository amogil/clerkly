...
- [ ] 1. Настройка базовой инфраструктуры тестирования
...
- [ ] 2. Реализация системы организации тестовых файлов
  - [ ] 2.1 Создать утилиты для проверки соответствия тестовых файлов исходным
...
- [ ] 3. Реализация системы моков для изоляции зависимостей
  - [ ] 3.1 Создать Mock System для файловой системы
