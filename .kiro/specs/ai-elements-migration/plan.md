...
- [ ] **12.3** Обновить таблицу покрытия требований в `design.md`
- [ ] **12.4** Обновить `tasks.md` — отметить все задачи выполненными
- [ ] **12.5** Запросить у пользователя запуск функциональных тестов
