    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Your schedule synced from Google Calendar</p>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border shadow-sm mb-6">
          <div className="p-4 border-b border-border flex items-center justify-between">
            ...
            <h2 className="font-semibold text-foreground">January 27 - February 2, 2026</h2>
            <button className="p-2 hover:bg-secondary rounded-lg transition-colors">
          ...
          <div className="grid grid-cols-7 divide-x divide-border">
            {currentWeek.map((day, idx) => {
              ...
              return (
                ...
                >
                  <div className="text-xs text-muted-foreground mb-2">{weekDays[idx]}</div>
                  <div
        ...
        <div className="bg-card rounded-xl border border-border shadow-sm">
          <div className="p-6 border-b border-border">
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              {selectedDayStats.count} meeting{selectedDayStats.count !== 1 ? "s" : ""} ·{" "}
              {selectedDayStats.duration} total
            </p>
          </div>
