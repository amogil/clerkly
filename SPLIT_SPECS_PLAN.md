...
- [ ] Создать `window-management/design.md` с:
  - Обзор
...
- [ ] Коммит: "feat: create window-management design"

### 2.2 Создать navigation/design.md
- [ ] Извлечь соответствующие секции из `ui/design.md`
- [ ] Создать `navigation/design.md` с:
  - Обзор
  ...
  - Стратегия тестирования
  - Таблица покрытия требований
- [ ] Коммит: "feat: create navigation design"
