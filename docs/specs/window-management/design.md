...
*Для любого* созданного главного окна, минимальная ширина должна быть установлена как 350px, а минимальная высота как 650px, чтобы пользователь не мог уменьшить окно ниже этого размера.
...
4. **Сохраненный размер меньше минимума (window-management.1.6)**: Когда сохраненная ширина меньше 350 или сохраненная высота меньше 650, система должна корректировать их до минимального размера.
