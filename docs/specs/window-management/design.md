...
### Property 5.1: Минимальный размер окна

*Для любого* созданного главного окна, минимальная ширина должна быть установлена как 350px, а минимальная высота как 300px, чтобы пользователь не мог уменьшить окно ниже этого размера.

**Validates: Requirements window-management.1.6**
...
4. **Сохраненный размер меньше минимума (window-management.1.6)**: Когда сохраненная ширина меньше 350 или сохраненная высота меньше 300, система должна корректировать их до минимального размера.
