...
4.11.3. КОГДА в тексте reasoning markdown-фрагмент с `**...**` следует сразу после обычного текста без пробела/переноса строки, UI ДОЛЖЕН отображать между ними пробел.
