...
### Completed
- ✅ 1.1 Обновить `docs/specs/agents/requirements.md` — переписаны 4.2.1, 4.2.2, 4.24; добавлено 4.24.5; удалён избыточный 4.24.4 (перенумерован 4.24.5→4.24.4); обновлены функц. тесты
- ✅ 1.2 Обновить `docs/specs/agents/design.md` — обновлён алгоритм action-кнопки, секция useAgentChat п.6, таблицы покрытия (функц. + требования)
...
- ✅ 2.2 Обновить ссылку `agents.4.24.5→4.24.4` в `src/main/agents/AgentIPCHandlers.ts`
- ✅ 3.1 Обновить unit-тесты — обновлены 3 существующих теста, добавлены 5 новых (38 тестов, все проходят)
- ✅ 4.1 Обновить функциональные тесты — заменён 1 тест на 4 новых (stop для пустого ввода, send при тексте, submit кликом, submit Enter-ом)
