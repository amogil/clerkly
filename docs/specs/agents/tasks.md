...
- [x] Обновить `docs/specs/llm-integration/{requirements,design}.md`:
  ...
  - [x] Зафиксировать валидацию title (max 200, target 3-12 слов) и anti-flapping правила.
...
- [x] Добавить/обновить functional-тесты (необходимый минимум):
  ...
  - [x] первое неосмысленное сообщение (например, `...`) не переименовывает `New Agent`;
