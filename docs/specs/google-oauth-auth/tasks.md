...
В рамках рефакторинга системы хранения данных (см. `docs/specs/database-refactoring/tasks.md`), необходимо обновить TokenStorageManager для использования UserSettingsManager вместо DataManager.
