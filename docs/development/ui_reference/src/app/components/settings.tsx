    ...
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Configure Clerkly to work the way you want</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-card rounded-xl border border-border shadow-sm">
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-foreground mb-1">Auto-join meetings</h3>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-foreground mb-1">Auto-transcribe</h3>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-foreground mb-1">Auto-create tasks</h3>
                  <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-card rounded-xl border border-border shadow-sm">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-foreground mb-1">Slack notifications</h3>
                  <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-card rounded-xl border border-border shadow-sm">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="pt-4 border-t border-border">
                <button className="text-sm text-red-600 hover:underline">Delete all my data</button>
              </div>
            </div>
          </div>
