...
Приложение следует фундаментальному архитектурному принципу, описанному в спецификации `clerkly` (см. `specs/specs/clerkly/requirements.md`), где **база данных является единственным источником истины** для всех данных приложения.
