      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Комплексная система обработки ошибок для Clerkly
          </p>
        </div>
              ...
              <div className="border-2 border-dashed border-border rounded-lg p-8">
                <div className="text-center max-w-md mx-auto">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Возникла проблема при загрузке информации. Попробуйте обновить страницу или вернуться позже.
                  </p>
            ...
            <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700">
                    Это вызовет критическую ошибку, которая будет перехвачена Error Boundary. Приложение не упадёт, и пользователь увидит понятное сообщение с возможностью восстановления.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-primary/5 rounded-xl border border-primary/20 p-6">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <div>
                ...
                <code className="px-2 py-0.5 bg-secondary rounded text-primary">useError()</code> для показа быстрых уведомлений
              </div>
              <div>
                <strong className="text-foreground">Inline ошибки:</strong> Встраивайте сообщения об ошибках прямо в интерфейс для контекстной обратной связи
              </div>
              <div>
                <strong className="text-foreground">Состояния ошибок:</strong> Показывайте полностраничные состояния при критических сбоях загрузки данных
              </div>
              <div>
                <strong className="text-foreground">Error Boundary:</strong> Автоматически перехватывает необработанные ошибки React и показывает понятное сообщение
              </div>
              <div>
                <strong className="text-foreground">Валидация форм:</strong> Визуализируйте ошибки валидации прямо под полями ввода
              </div>
            </div>
          </div>
        </div>
