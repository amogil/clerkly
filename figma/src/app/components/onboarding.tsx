      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Your AI clerk for modern teams. Let Clerkly handle the notes while you focus on
            what matters.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-12 text-center border border-primary/20">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            Connect your calendar and meeting tools to let Clerkly start working for you.
            Your AI clerk is ready to take notes.
          </p>
        ...
        <div className="mt-16 pt-16 border-t border-border">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Your data is encrypted end-to-end. Clerkly integrates with your existing
              tools without disrupting your workflow. SOC 2 Type II certified and GDPR
              compliant.
            </p>
          </div>
        </div>
