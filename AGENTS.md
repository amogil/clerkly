...
| GitHub (issues, PR, review comments, commit messages) | Английский |
| Названия файлов и переменных | Английский |

### Язык в GitHub

- Все коммуникации в GitHub ДОЛЖНЫ быть только на английском:
  - issues;
  - pull request descriptions;
  - review comments и ответы;
  - commit messages, связанные с PR.
- Русский язык в GitHub-коммуникации SHALL NOT использоваться.

### Язык комментариев в коде

- Все комментарии в коде ДОЛЖНЫ быть только на английском.
- Русские комментарии в коде SHALL NOT добавляться.
