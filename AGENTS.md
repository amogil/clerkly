...
**КРИТИЧЕСКИ ВАЖНО**: Функциональные тесты показывают окна приложения на экране и могут мешать работе пользователя.

### Когда НЕ запускать функциональные тесты:
...
### Когда МОЖНО запускать функциональные тесты:

- ✅ **ТОЛЬКО** при явной просьбе пользователя
- ✅ Когда пользователь явно указывает "запусти функциональные тесты"
- ✅ Когда пользователь явно указывает "запусти все тесты" (включая функциональные)
...
> "Функциональные тесты покажут окна приложения на экране и могут мешать работе. Продолжить?"
