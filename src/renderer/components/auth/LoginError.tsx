 ...
 *               google-oauth-auth.15.1, google-oauth-auth.15.2
 */
    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-2xl border border-border shadow-sm p-8">
          ...
          {/* Google Sign In Button - Requirements: google-oauth-auth.13.1, google-oauth-auth.13.7, google-oauth-auth.15.1, google-oauth-auth.15.2 */}
          <button
            onClick={onRetry}
