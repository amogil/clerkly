...
describe('Property Tests - Data Manager', () => {
  ...
  /* Preconditions: UserSettingsManager initialized, database has some valid data
  ...
  /* Preconditions: UserSettingsManager initialized with saved data
  ...
  /* Preconditions: UserSettingsManager initialized with multiple saved keys
